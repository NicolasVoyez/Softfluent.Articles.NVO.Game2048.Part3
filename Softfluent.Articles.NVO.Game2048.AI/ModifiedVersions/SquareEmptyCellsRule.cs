...
{
    public class PowEmptyCellsRule : AIRule, IDoubleBasedEvolution
    {
        internal PowEmptyCellsRule()
        {
                
        }

        public PowEmptyCellsRule(double coefficient)
        {
        ...
        public override double CalculatePoints(int[,] grid, Direction fromDirection, int gridSideSize)
        {
            ...
            return emptyCellsCount == 0 ? 0 : Coefficient *  Math.Pow(emptyCellsCount, _PowValue);
        }
